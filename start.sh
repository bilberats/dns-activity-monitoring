...
ssh thd@157.159.55.165 "cd ~/dns-activity-monitoring && bash ./start_dns_logs_monitoring.sh $MONITORING_INTERVAL $DURATION" &
SSH_PID=$!

bash ./component-monitoring/start_measurements.sh $MONITORING_INTERVAL $DURATION &
